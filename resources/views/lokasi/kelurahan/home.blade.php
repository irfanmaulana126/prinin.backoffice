        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header box-header with-border">
              <h3 class="box-title">Data Lokasi Kelurahan</h3>
              ...
              <div class="row  pull-right">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-default"><i class="fa fa-upload"></i></button>
                      <a href="{{url('/master/lokasi/kelurahan/create')}}" type="submit" class="btn btn-default"><i class="fa fa-plus"></i></a> 
                </div>
                <br>
                <br>
              </div>
              ...
              <table class="table table-responsive no-padding table-hover">
                ...
                <tr>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="{{url('/master/lokasi/kelurahan/edit/'.$kelurahan->id)}}"><i class="fa fa-edit"></i>Edit</a></li>
                    <li><a href="{{url('/master/lokasi/kelurahan/destroy/'.$kelurahan->id)}}"><i class="fa fa-trash"></i>Hapus</a></li>
                  </ul>
                </div></td>
                </tr>
                @endforeach
