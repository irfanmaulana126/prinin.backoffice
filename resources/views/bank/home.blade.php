              ...
              <div class="row  pull-right">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-default"><i class="fa fa-upload"></i></button>
                      <a type="submit" href="{{url('/master/bank/create')}}" class="btn btn-default"><i class="fa fa-plus"></i></a> 
                </div>
                <br>
                <br>
              </div>
              <div class="row">
                ...
                <tr>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="{{url('/master/bank/edit/'.$bank->id)}}"><i class="fa fa-edit"></i>Edit</a></li>
                    <li><a href="{{url('/master/bank/destroy/'.$bank->id)}}"><i class="fa fa-trash"></i>Hapus</a></li>
                  </ul>
                </div></td>
                </tr>
                @endforeach
